...
import { FilteringService } from '../_services/filtering.service'; // Import FilteringService
import { AlignmentService } from '../_services/alignment.service'; // Import AlignmentService
...
export class FileDetailsComponent implements OnInit {
  ...
  progress: number = 0;
  selectedFile: string = ''; // Add selectedFile for filtering
  ...
  referenceFiles: any[] = []; // Add referenceFiles for alignment
  selectedReferenceFile: string = '';
  selectedFileToUpload: File | null = null;
  showReferenceModal: boolean = false; // To toggle the display of the reference modal

  activeTab: string = 'Analyze'; // Initialize with default tab

  constructor(
    private route: ActivatedRoute,
    private fileManagementService: FileManagementService,
    private qualityControlService: QualityControlService,
    private filteringService: FilteringService, // Inject FilteringService
    private alignmentService: AlignmentService, // Inject AlignmentService
  ...
  getFileInfo(): void {
    this.isLoading = true;
    this.fileManagementService.getFileInfo('fastq-files', this.fileName).subscribe(
      (response) => {
